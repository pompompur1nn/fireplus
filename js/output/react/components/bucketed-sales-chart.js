class BucketedSalesChart extends React.Component {
  ...
  setChartDataForDays(days, mode) {
    ...
    if (this.props.seriesTranslator) {
      ...
      var chartData = Object.assign({
        series: [Highcharts.toHighchartsSeries(this.props.name, this.filterItems(minDate, maxDate, translatedSalesData))]
      }, this.chartDataBase);
      chartData.xAxis.min = minDate.getTime();
      chartData.xAxis.max = maxDate.getTime();
      this.setState({
  ...
  loadStatusSuccess(status) {
    if (status) {
      ...
      this.setState({
        loadStatus: /*#__PURE__*/React.createElement("span", {
          class: "text-secondary"
        }, "Data is actively being scanned... ", `(transactions: ${status.count}, cursor: ${cursor.substring(0, 20)})`)
      });
    } else {
      this.setState({
        loadStatus: ""
  ...
  render() {
    return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h3", null, this.props.name), /*#__PURE__*/React.createElement("div", {
      ...
      class: "item-sales-controls"
    }, /*#__PURE__*/React.createElement("div", {
      class: "select-group rbx-select-group item-sales-mode"
      ...
      value: this.modes.hourly
    }, "Hourly"), /*#__PURE__*/React.createElement("option", {
      value: this.modes.daily
