class RobuxHistoryChart extends React.Component {
  ...
  setChartData(mode, days) {
    ...
    var chartData = Object.assign({
      series: [Highcharts.toHighchartsSeries(this.state.chartName, translatedRobuxHistory)]
    }, this.chartDataBase);
...
RPlus.robuxHistory.isEnabled().then(robuxHistoryEnabled => {
  ...
  let robuxHistoryChart = ReactDOM.render( /*#__PURE__*/React.createElement(RobuxHistoryChart, {
    currencyHolderType: "User",
    currencyHolderId: Roblox.users.authenticatedUserId,
    days: currentDays
  }), robuxHistoryContainer[0]);
